...
const createStyles = (colors: typeof Colors.light) =>
  ...
  button: { backgroundColor: colors.tint, borderRadius: 12, padding: 16, alignItems: 'center' },
  buttonDisabled: { opacity: 0.7 },
  buttonText: { color: '#fff', fontSize: 16, fontWeight: '600' },
  registerButton: { alignItems: 'center', padding: 16, marginTop: 24 },
  registerText: { color: colors.mutedText, fontSize: 14 },
  registerTextBold: { color: colors.tint, fontWeight: '600' },
  demoHint: { marginTop: 16, padding: 12, backgroundColor: colors.cardMuted, borderRadius: 8 },
  demoHintText: { fontSize: 12, color: colors.mutedText, textAlign: 'center' },
});
